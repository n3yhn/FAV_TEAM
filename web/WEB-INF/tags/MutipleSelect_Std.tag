...
<script>
    ...
    new dijit.form.ComboBox({
        ...
        onKeyPress: function(event) {
            ...
            if (key == 13) {
                var name = document.getElementById("selecter-input${id}").value;
                //var abbr = name.match(/[A-Z]/g).join('');
                var officeName = String(name).replace(/"/g, '&quot;').replace(/'/g, '&#39;');
                var officeCode = "";
                var exitId = "-1";
                /*
...
<div tabindex="0" class="x-form-field-wrap" style="width: 100%;margin: 0;padding: 0;margin-left: 1px;word-wrap: break-word;ss"     
