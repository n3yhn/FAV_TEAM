...
<form id="createForm" name="createForm">
    <table width="100%" cellpadding="0px" cellspacing="5px">
        ...
        <tr>
            <td>
                <sd:TextBox id="createForm.technicalStandardId" name="createForm.technicalStandardId" cssStyle="display:none" key=""/>
                <sd:TextBox id="createForm.standardType" name="createForm.standardType" cssStyle="display:none" key=""/>
                <sx:Label key="Số hiệu qui chuẩn:" require="true"/>
            </td>
            <td>
            ...
            <td>
                <sx:Label key="Tên tiếng Việt qui chuẩn:" require="true"/>
            </td>
            <td>
                <sd:TextBox cssStyle="width:100%" trim="true"
        ...
        <tr>
            <td>
                <sx:Label key="Tên tiếng Anh qui chuẩn:" require="true"/>
            </td>
            <td>
                <sd:TextBox cssStyle="width:100%" trim="true"
        ...
        <tr>
            ...
            <td>
                <sd:TextBox cssStyle="width:100%" trim="true"
                            id="createForm.publishAgencyName"
                            name="createForm.publishAgencyName"
                            key=""
                            maxlength="200"
                            />
            </td>
        ...
        <tr>
            <td>
                <sx:Label key="Ngày hết hạn:" require="true"/>
            </td>
            <td>
                <sx:DatePicker cssStyle="width:100%"
...
<script>
    page.validate = function() {
        ...
        if (standardCode == null || standardCode.trim().length == 0) {
            alert("Bạn chưa nhập mã qui chuẩn");
        ...
        if (vietnameseName == null || vietnameseName.trim().length == 0) {
            alert("Bạn chưa nhập tên tiếng Việt qui chuẩn");
        ...
        if (englishName == null || englishName.trim().length == 0) {
            alert("Bạn chưa nhập tên Tiếng Anh qui chuẩn");
        ...
        var publishAgencyName = dijit.byId("createForm.publishAgencyName").getValue();
        if (publishAgencyName == null || publishAgencyName.trim().length == 0) {
            alert("Bạn chưa nhập đơn vị ban hành");
            dijit.byId("createForm.publishAgencyName").focus();
            return false;
        }
        ...
        if (scope == null || scope.trim().length == 0) {
            alert("Bạn chưa nhập phạm vi qui chuẩn");
    ...
    page.save = function() {
        if (page.validate()) {
            sd.connector.post("technicalStandardAction!onInsert.do?" + token.getTokenParamString(), null, "createForm", null, page.afterSave);
        }
    };
    ...
    page.afterSave = function(data) {
        ...
        if (result0 == "3") {
            ...
            var Id = dijit.byId("createForm.technicalStandardId").getValue();
            if (Id == null || Id == "") {
