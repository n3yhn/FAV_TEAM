...
<form id="categoryAddEditForm">
    <table width="100%;" cellpadding="0px" cellspacing="5px">
        ...
        <tr>
            ...
            <td>
                <sd:TextBox cssStyle="width:100%" trim="true"
                            id="categoryAddEditForm.description"
                            key=""
                            name="categoryAddEditForm.description"
                            maxlength="200"
                            >
                </sd:TextBox>
            </td>
        ...
        <tr>
            ...
            <td>
                <sd:SelectBox id="categoryAddEditForm.isActive" name="categoryAddEditForm.isActive" key="" >
...
<script>
    ...
    page.save = function() {
        ...
        var isActive = dijit.byId("categoryAddEditForm.isActive").getValue();
        if (isActive < 0) {
            alert("Bạn chưa chọn trạng thái");
            dijit.byId("categoryAddEditForm.isActive").focus();
            return false;
        }
