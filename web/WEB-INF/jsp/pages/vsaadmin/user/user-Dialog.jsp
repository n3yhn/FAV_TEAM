            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td class="tdOnForm">
                        ...
                        <sd:TextBox trim="true" id="usersFormOnDialog.userName" name="usersForm.userName" key="" cssStyle="width:80%" maxlength="100"/>                         
                    ...
                    <td class="tdOnForm">
                        <sd:TextBox trim="true" id="usersFormOnDialog.fullName" name="usersForm.fullName" key="" cssStyle="width:80%" maxlength="100"/>
                    </td>
                </tr>
                <tr id="trPassword">
                    <td>
                    ...
                    <td class="tdOnForm">
                        <sd:TextBox trim="true" id="usersFormOnDialog.password" name="usersForm.password" key="" cssStyle="width:80%" type="password" maxlength="50"/>
                    </td>
                    ...
                    <td class="tdOnForm">
                        <sd:TextBox trim="true" id="retypePassword" name="retypePassword" key="" cssStyle="width:80%" type="password" maxlength="50"/>
                ...
                <tr>
                    ...
                    <td class="tdOnForm">
                        <sd:TextBox trim="true" id="usersFormOnDialog.email" name="usersForm.email" key="" cssStyle="width:80%" maxlength="50"/>
                    </td>
                ...
                <tr>
                    ...
                    <td class="tdOnForm">
                        <sd:TreePicker id="userDeptTree" getChildrenNodeUrl="departmentAction!getDeptChildrenDataByNode.do"
                ...
                <tr>
                    ...
                    <td><sx:Label key="usersFormOnDialog.status" require="true"/></td>
                    <td>
        ...
        <sd:FieldSet key="usersForm.addInfo" theme="blue">
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td class="tdOnForm">
                        <sd:TextBox trim="true" id="usersFormOnDialog.identityCard" name="usersForm.identityCard" key="usersForm.identityCard" cssStyle="width:80%" maxlength="15" required="true" mask="digit"/>
                    </td>
                </tr>
                <tr>
                    <td class="tdOnForm">
