    ...
    <form id="departmentFormOnDialog" name="departmentForm">
        <table width="100%">
            ...
            <tr>
                ...
                <td class="tdOnForm">
                    <sd:TextBox id="departmentFormOnDialog.deptName" required="true" name="departmentForm.deptName" key=""  cssStyle="width:80%" maxlength="300" trim="true" />
                </td>
                <td>
                    <sx:Label key="departmentForm.deptCode" require="true"/>
                </td>
                <td class="tdOnForm">
                    <sd:TextBox id="departmentFormOnDialog.deptCode" required="true" name="departmentForm.deptCode" key="" cssStyle="width:80%" maxlength="20" trim="true"/>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td class="tdOnForm">
                    <sd:SelectBox id="departmentFormOnDialog.type" required="true" key=""
                ...
                <td class="tdOnForm">
                    <sd:SelectBox id="departmentFormOnDialog.status" required="true" key="" name="departmentForm.status" cssStyle="width:80%" trim="true">
            ...
            <tr>
                ...
                <td class="tdOnForm">
                    <sd:TextBox id="departmentFormOnDialog.address" name="departmentForm.address" key="" cssStyle="width:80%" maxlength="50" trim="true"/>
                </td>
        ...
        <table width="100%">
            <tr>
                <td style="text-align:center;">
                    <sd:Button id="departmentFormOnDialog.btnUpdate" key="btnUpdate" onclick="page.onUpdate()"/>
                    <sd:Button id="departmentFormOnDialog.btnInsert" key="btnInsert" onclick="page.onInsert()"/>
                </td>
            </tr>
        </table>
