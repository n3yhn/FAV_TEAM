...
<sd:TitlePane key="menu.report.filter" id="tltpn1">
    <div id="resetPasswordReportFilterFormDiv">
    ...
    <div align="center">
        ...
        <sd:Button id="resetPasswordReportForm.excel" key="" onclick="page.onExcelresetPassword()" >
...
<sd:TitlePane key="menu.report.result" id="tltpn2">
    <form id="form1">
        <div id="gridDiv" style="width:100%;height:500px">
            <sd:DataGrid clientSort="true" getDataUrl="/vsaadminv3/ResetPasswordReportAction!onInitResetPassword.do" id="gridId" style="width:100%; height:100%;" container="gridDiv" rowSelector="20px">
                ...
                <sd:ColumnDataGrid editable="false" key="report.dateOfBirth" field="dateOfBirth" width="15%"/>
                <sd:ColumnDataGrid editable="false" key="report.identityCard" field="identityCard" width="15%"/>
...
<script>
    ...
    page.onView = function(){
        ...
        dijit.byId('gridId').vtReload("ResetPasswordReportAction!onViewResetPassword.do" + ext,"reportForm") ;
    }
    page.onExcelresetPassword = function(){
        var temp = "" + dijit.byId('reportForm.deptId').value;
        if (temp == ""){
            alert('Bạn chưa chọn phòng ban!');
            return false;
        ...
        window.location = "ResetPasswordReportAction!onExcelResetPassword.do" + ext;
    }
</script>