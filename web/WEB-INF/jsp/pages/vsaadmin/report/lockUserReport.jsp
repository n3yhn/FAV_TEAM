        ...
        <form id="reportForm" name="reportForm">
            <table width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <sd:Label key="adForm.description"/>
                    </td>
                    <td>
                        <sd:TextBox id="reportForm.description" name="reportForm.description" key="" cssStyle="width:80%" trim="true"/>
                    </td>
                </tr>
            </table>
        </form>
...
<script>
    ...
    page.onView = function(){
        ...
        dijit.byId('gridId').vtReload("LockUserReportAction!onViewLockUser.do" + ext,"reportForm") ;
    }
    page.onExcelCreateUser = function(){
        ...
        if (dijit.byId('reportForm.description').value != ""){
            ext += "&description=";
            ext += dijit.byId('reportForm.description').value;
        }

        window.location = "LockUserReportAction!onExcelLockUser.do" + ext;
    }
</script>