...
<script type="text/javascript">
    ...
    page.callbackCheckName = function(data, bSuccess)
    {
        ...
        if (result == 'false') {
            ...
            page.alert("Thông báo", "Tên phòng ban đã tồn tại ", "warning");
    ...
    page.callbackCheckCode = function(data, bSuccess)
    {
        ...
        if (result == 'false') {
            ...
            {
                page.alert("Thông báo", "Bạn chưa chọn loại phòng ban", "warning");
            ...
            if (dijit.byId("departmentFormOnDialog.telephone").getValue()) {
                if (!validatePhone(dijit.byId("departmentFormOnDialog.telephone").getValue())) {
                    page.alert("Thông báo", "<sd:Property>msg.incorrectTel</sd:Property>", "warning");
                    dijit.byId("departmentFormOnDialog.telephone").focus();
                    return false;
                }
            }
            ...
            if (dijit.byId("departmentFormOnDialog.tel").getValue()) {
                if (!validatePhone(dijit.byId("departmentFormOnDialog.tel").getValue())) {
                    page.alert("Thông báo", "<sd:Property>msg.incorrectTel</sd:Property>", "warning");
                    dijit.byId("departmentFormOnDialog.tel").focus();
                    return false;
                }
            }
            if (dijit.byId("departmentFormOnDialog.tin").getValue()) {

                if (!sd.validator.isNumberFormatNoneZero(dijit.byId("departmentFormOnDialog.tin").getValue())) {
                    page.alert("Thông báo", "<sd:Property>msg.incorrectTin</sd:Property>", "warning");
                    dijit.byId("departmentFormOnDialog.tin").focus();
                    return false;
                } else
                {
                    dijit.byId("departmentFormOnDialog.tin").setValue(dijit.byId("departmentFormOnDialog.tin").getValue().replace(/^(0*)/, ""));
                }
            }
            if (dijit.byId("departmentFormOnDialog.fax").getValue()) {
                if (!validatePhone(dijit.byId("departmentFormOnDialog.fax").getValue())) {
                    page.alert("Thông báo", "<sd:Property>msg.incorrectFax</sd:Property>", "warning");
                    dijit.byId("departmentFormOnDialog.fax").focus();
                    return false;
                }
            }
            ...
            page.alert("Thông báo", "Mã phòng ban đã tồn tại ", "warning");
    ...
    page.callback = function(data, bSuccess) {
        ...
        switch (data.customInfo[0]) {
            case "deleteSuccess":
                ...
                sd.connector.post("departmentAction!getTree.do", "treeDiv", null, null);
                break;
            case "deletePart":
    ...
    page.preInsert = function() {
        page.clearFormOnDialog();
        var dialog = dijit.byId("dialogDeptId");
        dialog.titleNode.innerHTML = "Thêm mới phòng ban";
        ...
        //                sd._("departmentFormOnDialog.parentId").setValue(sd._("departmentForm.deptId").getValue());
    ...
    page.onInsert = function() {
        ...
        //cont check telephone
        //page.onCheckName();
        page.onCheckCode();
    }

    page.insertDept = function(inRow) {
        dijit.byId('deptGridId').vtReload("departmentAction!onInsert.do?" + token.getTokenParamString(), "departmentFormOnDialog", null, page.callback);
    }
    //********************************UPDATE************************************
    ...
    page.updateDept = function() {
        dijit.byId('deptGridId').vtReload("departmentAction!onUpdate.do?" + token.getTokenParamString(), "departmentFormOnDialog", null, page.callbackByUpdate);
    }
    ...
    page.preAddUserToDept = function(rowIndex) {
        ...
        sd._("addUserToDeptForm.deptId").setValue(row.deptId);
        dialog.show();
        dijit.byId("listUnassignedUserGridId").vtReload("", null);
    }
    //---------------------
    ...
    page.closeDialogDeptId = function() {
        dijit.byId("dialogDeptId").hide();
    };
</script>