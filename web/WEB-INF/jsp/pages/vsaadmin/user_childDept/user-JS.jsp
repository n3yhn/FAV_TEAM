...
<script>
    ...
    --%>
            ...
            page.onSearch = function (){
                ...
                dijit.byId('listUserGridId').vtReload("UserAction!onSearch.do?searchType='local'","usersForm", null, null) ;
            };
            //********************************SEARCH User Of Dept***********************
            page.onSearchUserOfDept = function (){
                ...
                dijit.byId('listUserGridId').vtReload("UserAction!onSearchUserOfDept.do","usersForm", null, null) ;
            };
            //********************************INSERT************************************
...
//                }
                ...
                if(!dijit.byId("usersFormOnDialog.deptId").attr("value") || dijit.byId("usersFormOnDialog.deptId").attr("value") < 0){
                    page.alert("Thông báo","<sd:Property>msg.user.deptNull</sd:Property>", "warning");
                    dijit.byId("usersFormOnDialog.deptId").focus();
                    return false;
                }
                
                if(dijit.byId("usersFormOnDialog.businessId").getValue() != null &&dijit.byId("usersFormOnDialog.businessId").getValue()>0){
                    var businessName = dijit.byId("usersFormOnDialog.businessId").attr("displayedValue");
                    dijit.byId("usersFormOnDialog.businessName").setValue(businessName);
                }
    ...
    <%--sd._("usersFormOnDialog.ip").setValue(dojo.trim(dijit.byId("usersFormOnDialog.ip").getValue()));--%>
                ...
                /*
                if(dijit.byId("usersFormOnDialog.type").attr("value") == 0 || document.getElementById("usersFormOnDialog.staffId").value == null || document.getElementById("usersFormOnDialog.staffId").value == 0){
                    page.alert("Thông báo",'Chưa chọn cán bộ, học viên', "warning");
                    document.getElementById("usersFormOnDialog.staffId").focus();
                    return false;
                }
                 */
                if(dijit.byId("usersFormOnDialog.businessId").getValue() != null &&dijit.byId("usersFormOnDialog.businessId").getValue()>0){
    ...
    <%-- sd.widget.__setReadOnly("usersFormOnDialog.ip",false);
     sd.widget.__setReadOnly("usersFormOnDialog.ignoreCheckIp",false);--%>
             ...
             page.searchUnassignedRole= function(){
                 ...
                 dijit.byId("unassignedRoleGridId").vtReload("UserAction!searchRoleOfUserDept.do", "userRoleFormOnDialog", null, null);
             };
             // ]
             ...
             page.onLock = function(){
                 ...
                 for(var j = 0; j < items.length;j++){
                     item = items[j];
                     if(item != undefined && item.status != 0){
