...
<script>
    ...
    page.resetPass = function(inRow){
        ...
        if(item != null){
            var url = "<div><img style='cursor: pointer; cursor: hand;' src='share/images/icons/reset.png' title='Reset password' onClick='page.clickResetPasswordImg(" + inRow + ")' height='20' width='20' /></div>";
            return url;
        }
    }
...
<sd:TitlePane key="usersForm.search" id="userTltpn">
        ...
        <form id="usersForm" name="usersForm">
            <table  width="100%" align="center">
                ...
                <tr>
                    ...
                    <td >
                        <sd:TextBox id="usersForm.userName" name="usersForm.userName" key="" cssStyle="width:80%" trim="true"/>
                    </td>
                    <td>
                        <sd:Label key="usersForm.fullName" />
                    </td>
                    <td >
                        <sd:TextBox id="usersForm.fullName" name="usersForm.fullName" key="" cssStyle="width:80%" trim="true"/>
                    </td >
                ...
                <tr>
                    ...
                    <td >
                        <sd:TextBox id="usersForm.cellphone" name="usersForm.cellphone" key="" mask="^\d*$" cssStyle="width:80%" trim="true"/>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td >
                        <sd:TreePicker id="userSearchChildDeptTree" getChildrenNodeUrl="departmentAction!getDeptChildrenDataByNode.do"
    ...
    <div align="center" style="padding-top:10px;">
        <sd:Button id="usersForm.btnSearch" key="" onclick="page.onSearchUserOfDept()" >
    ...
    <form id="listUserGridForm">
        ...
        <div id="listUserGridDiv" style="width:100%;">
            <sd:DataGrid clientSort="true" 
                         getDataUrl="UserAction!onSearchUserOfDept.do?" 
                         id="listUserGridId" 
                ...
                <sd:ColumnDataGrid headerStyles="text-align:center;font-weight: bold" editable="false" key="usersForm.cellphone" field="cellphone" width="8%"/>
...
<br/>
<script>
            dijit.byId("userSearchChildDeptTree").onPickData = function(item){
        try{
            if(item.id){
                sd._("usersForm.deptId").setValue(item.id);
            }else{
                sd._("usersForm.deptId").setValue("");
                sd._("userSearchChildDeptTree").setValue("");
            }
        }catch(err){
            alert(err.message);
        }
