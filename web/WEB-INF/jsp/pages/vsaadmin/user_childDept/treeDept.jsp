...
<table class="treeContainer">
    <tr>
        <td class="padding-10">
            <sd:AjaxTree id="deptTreeId" getChildrenUrl="departmentAction!getChildrenDataByNode.do" getTopLevelUrl="departmentAction!getMyDeptRootTree.do" rootLabel="usersForm.department" onClick="page.onNodeClick"/>
        </td>
    </tr>
</table>
