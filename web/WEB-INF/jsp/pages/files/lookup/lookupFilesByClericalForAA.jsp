...
<jsp:include page="pluginJSC.jsp" flush="false"></jsp:include>
    ...
    <script type="text/javascript">
        ...
        page.search = function () {
            dijit.byId("filesGrid").vtReload('filesAction!onsearchLookupFilesByClerical.do?', "searchForm", null, page.afterSearch);
        };
        ...
        page.formatLinkDownloadFileLDCSignApprove = function (fileId) {
            document.location = "uploadiframe!openFileLDCSignApproveForAA.do?fileId=" + fileId;
        };
        ...
        page.onSign = function (fileId, isSignMore) {
            ...
            sd.connector.post("uploadiframe!openFileUserAttachPdfSignForAA.do?fileId=" + fileId + "&signType=" + signType, null, null, null, signAfterC);
        };
...
//                var sign2;
                ...
                if (signType == "PDHS") {
                    var signTypeCheck = "PDHS_VT";
//                    sign2 = signAndSubmitOriginalFileForAA();
//                    signData2 = encodeBase64(sign2);
                }
                if (signType == "CVBS") {
                    var signTypeCheck = "CVBS_VT";
                }
                sd.connector.post("filesAction!onSignPluginAA.do?fileId=" + fileId + "&outPutPath=" + outPutPath + "&signData=" + signData + "&signType=" + signTypeCheck + "&fileName=" + fileName, null, null, null, page.afterSignPluginC);
            } else
            {
