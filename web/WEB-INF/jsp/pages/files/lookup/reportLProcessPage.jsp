                ...
                <td>
                    <div id="fileGridDiv" style="width:100%;">
                        <sd:DataGrid id="filesGrid"
                            ...
                            <sd:ColumnDataGrid  key="Tên cán bộ xử lý hồ sơ" field="leaderName"
                                                width="20%"  headerStyles="text-align:center;" />
                            <sd:ColumnDataGrid  key="Tổng số hồ sơ đang xử lý" field="totalProcessing"  cellStyles="text-align:center;"
                                                width="20%"  headerStyles="text-align:center;" />
                            <sd:ColumnDataGrid  key="Tổng số hồ sơ đã xử lý" field="totalProcessed"  cellStyles="text-align:center;"
                                                width="20%"  headerStyles="text-align:center;" />                            
                            <sd:ColumnDataGrid  key="Tổng số hồ sơ xử lý" field="totalProcess"  cellStyles="text-align:center;"
                                                width="20%"  headerStyles="text-align:center;" />
                        </sd:DataGrid>
                    </div>
                </td>
...
<script type="text/javascript">
    ...
    page.search = function() {
        dijit.byId("filesGrid").vtReload('filesAction!onsearchReportLProcess.do', "searchForm");
    };
