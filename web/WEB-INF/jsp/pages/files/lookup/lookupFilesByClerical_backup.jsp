...
<div id="showContent" style="width: 450px; height: 200px; display: none" />  
</div>
...
<script type="text/javascript">
    ...
    page.onSign = function(fileId, isSignMore) {
        ...
        sd.connector.post("uploadiframe!openFileUserAttachPdfSign.do?fileId=" + fileId + "&signType=" + signType, null, null, null, signAfter);
    }
    ...
    page.showSignMore = function() {
        if (!dijit.byId("filesGrid").vtIsChecked()) {
            ...
            signIndex = 0;
            msg.confirm('Bạn có chắc chắn muốn ký số phê duyệt nhiều hồ sơ?', '<sd:Property>confirm.title1</sd:Property>', loginCa);
                    }
                }
                ...
                page.getHtml = function()
                {
                    ...
                    item += '<PARAM name="fileId" value="' + signFileId + '">';
                    item += '<PARAM name="signType" value="' + signType + '">';
                    item += '<PARAM name="roleType" value="VT">';
