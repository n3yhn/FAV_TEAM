...
<script type="text/javascript">
    ...
    <div>
    <sx:ButtonAddCategory onclick="createNewRowOfAttach('','','','','attachTbl');"/>
</div>
    ...
    page.afterLoadAttach = function(data) {
        ...
        if (result != null && result.length > 0) {
            for (var i = 0; i < result.length; i++) {
                var item = result[i];
                createNewRowOfAttach(item.attachId, item.categoryName, item.attachDes, item.attachName, 'attachTbl');
            }
        }
    };
    /*
