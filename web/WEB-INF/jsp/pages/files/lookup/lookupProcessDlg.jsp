...
<script type="text/javascript">
    page.getNo = function(index) {
        return dijit.byId("documentProcessGridId").currentRow + index + 1;
    };
...
//    };
    ...
    page.statusFormat = function(inRow) {
        var item = dijit.byId("documentProcessGridId").getItem(inRow - 1);
        if (item == null) {
            return "";
        }
        var str = "";
...
<div id="documentProcessGridDiv" style="width:100%; overflow-y: auto;max-height: 500px">
    <%--
    ...
    <sd:DataGrid clientSort="false" 
                 id="documentProcessGridId"
                 style="width:auto;height:auto"
                 getDataUrl="" 
                 container="documentProcessGridDiv" 
                 serverPaging="true"
                 rowSelector="0%" 
                 rowsPerPage="100"> 
...
<script type="text/javascript">
    page.getProcess = function(objectId) {
        /*
         var callback = function(data) {
         drawProcessFromGridData(data, "dataFlow");
         };
         dijit.byId("documentProcessGridId").vtReload("filesAction!loadFLowView.do?flowForm.fileId=" + objectId, null, null, callback);
         */
        dijit.byId("documentProcessGridId").vtReload("filesAction!loadFLowView.do?flowForm.fileId=" + objectId, null, null, null);
    };
</script>