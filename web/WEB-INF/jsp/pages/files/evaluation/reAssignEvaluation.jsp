                    ...
                    <div style="width:100%;">
                        <sd:DataGrid id="filesGrid"
                            ...
                            <sd:ColumnDataGrid  key="Tên sản phẩm" field="productName"  cellStyles="text-align:left;"
                                                width="15%"  headerStyles="text-align:center;" />                            
                            <sd:ColumnDataGrid  key="CV xử lý chính" field="nameStaffProcess"  cellStyles="text-align:center;"
                                                width="15%"  headerStyles="text-align:center;" />                            
...
<script type="text/javascript">
    ...
    page.search = function () {
        if (page.validateSearch()) {
            dijit.byId("filesGrid").vtReload('filesAction!onReAssignEvaluation.do?', "searchForm", null, page.afterSearch);
        }
    };
