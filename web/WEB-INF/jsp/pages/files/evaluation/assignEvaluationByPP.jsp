                ...
                <td>
                    <div style="width:100%;">
                        <sd:DataGrid id="filesGrid"
                            ...
                            <sd:ColumnDataGrid editable="true" key="Phân công" headerStyles="text-align:center;" width="5%" cellStyles="text-align:center;"
                            ...
                            <sd:ColumnDataGrid  key="Cán bộ xử lý chính" field="nameStaffProcess"  cellStyles="text-align:center;"
                                                width="15%"  headerStyles="text-align:center;" />
                            <%--
                            <sd:ColumnDataGrid  key="Chuyên viên thẩm định" field="proposeUserName"
                                                width="15%"  headerStyles="text-align:center;" cellStyles="text-align:left;" />
                            --%>
                        </sd:DataGrid>
                    </div>
                </td>
...
<script type="text/javascript">
    ...
    page.showViewFile = function (fileId) {
        doGoToMenu("filesAction!toFileDlgView.do?fileId=" + fileId + "&viewType=-1" + "&backPage=7");
    };
            ...
            msg.confirm('Bạn có chắc chắn muốn phân công nhiều hồ sơ?', '<sd:Property>confirm.title1</sd:Property>', page.showAssignMorePopup);
                ...
                page.search = function () {
                    if (page.validateSearch()) {
                        dijit.byId("filesGrid").vtReload('filesAction!onAssignEvaluationByPP.do?', "searchForm");
                    }
                };
                page.reset = function () {
