...
<sd:Dialog  id="approveDlg" height="auto" width="600px"
            key="Nhập kết quả phê duyệt" showFullscreenButton="false"
            >
    <jsp:include page="approveForm.jsp" flush="false"></jsp:include>
</sd:Dialog>
<sd:Dialog  id="assignApproveDlg" height="auto" width="600px"
            key="Nhập kết quả phê duyệt" showFullscreenButton="false"
            >
    <jsp:include page="assignApproveDlg.jsp" flush="false"></jsp:include>
</sd:Dialog>
...
<script type="text/javascript">
    ...
    page.search = function () {
        dijit.byId("filesGrid").vtReload('filesAction!onSearchFileToAssignApprove.do', "searchForm");
    };
    ...
    page.showApproveForm = function (row) {
        ...
        page.replaceBrTblApproveForm();//6969
    };
    page.showAssignApproveForm = function (row) {
        var file = dijit.byId("filesGrid").getItem(row);
        dijit.byId("assignApproveDlgForm.fileId").setValue(file.fileId);
        document.getElementById("assignApproveDlgForm.businessName").innerHTML = escapeHtml_(file.businessName);
        document.getElementById("assignApproveDlgForm.productName").innerHTML = escapeHtml_(file.productName);
        dijit.byId("assignApproveDlg").show();
    };
