...
<form id="evaluateForm" name="createForm">
    <table width="100%" class="viewTable">
        ...
        <tr>
            ...
            <td>
                <sd:Textarea key="" id="evaluateForm.staffRequest" name="createForm.staffRequest" rows="4" cssStyle="width:99%" maxlength="2000" trim="true"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <sd:Textarea key="" id="evaluationRecordsForm.legalContent" name="createForm.evaluationRecordsForm.legalContent" rows="4" cssStyle="width:99%" maxlength="2000" trim="true"/>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="text-align: right"><sd:Label key="Lý do không cấp hoặc yêu cầu bổ sung"/></td>
            <td>
                <sd:Textarea key="" id="evaluationRecordsForm.foodSafetyQualityContent" name="createForm.evaluationRecordsForm.foodSafetyQualityContent" rows="4" cssStyle="width:99%" maxlength="2000" trim="true"/>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="text-align: right"><sd:Label key="Lý do không cấp hoặc yêu cầu bổ sung"/></td>
            <td>
                <sd:Textarea key="" id="evaluationRecordsForm.effectUtilityContent" name="createForm.evaluationRecordsForm.effectUtilityContent" rows="4" cssStyle="width:99%" maxlength="2000" trim="true"/>
            </td>
        </tr>
        <tr>
