...
<div id="announcementDiv">
        ...
        <table class="editTable">
            <tr>
                ...
                <td width="25%"><sd:Label >Số đăng ký kinh doanh/số CMT</sd:Label></td>
                    <td width="25%">
                        <div id="createForm.announcement.businessLicence"> ${fn:escapeXml(createForm.announcement.businessLicence)} </div>
                </td>
            </tr>
            <tr>
    ...
    <sd:FieldSet key="Thông tin công bố">
        <table class="editTable" id="detailDiv2">
            <tr>
...
<script type="text/javascript">
    page.replaceNewLineByBr = function() {
        var table = document.getElementById("detailDiv2");
    ...
    page.checkModifiredTabAnnouncementForConfirm = function() {
        ...
        if (announcementId != null && announcementId > 0) {
            ...
            //announcement.businessLicence
            a = '${fn:escapeXml(createFormOriginal.announcement.businessLicence)}';
            b = '${fn:escapeXml(createFormClone.announcement.businessLicence)}';
            if (a != b) {
                document.getElementById("createForm.announcement.businessLicence").style.color = "#ff0000";
            }
            ...
            //announcement.manufactureName 1
            ...
            //announcement.manufactureAddress 2
            ...
            //announcement.manufactureEmail 5
            ...
            //announcement.matchingTarget 8
            a = '${fn:escapeXml(createFormOriginal.announcement.matchingTarget)}';
            b = '${fn:escapeXml(createFormClone.announcement.matchingTarget)}';
            if (a != b) {
                document.getElementById("createForm.announcement.matchingTarget").style.color = "#ff0000";
            }
            //announcement.publishDate 9
    ...
    page.checkModifiredTabAnnouncementForConfirm();
