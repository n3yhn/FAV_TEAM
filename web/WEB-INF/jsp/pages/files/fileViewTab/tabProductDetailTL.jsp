...
<script type="text/javascript">
    ...
    createNewMainlyTargetRow = function (isTemp, mainlyTargetId, targetName, unitId, publishLevel, meetLevel) {
        ...
        meetLevel = stringToExponentDisplay(meetLevel);
        meetLevel = stringToExponentDisplaySupscript(meetLevel);
...
<div id="productDetailDiv">
    <table class="viewTable" id="tblDetailDiv">
        ...
        <tr>
            ...
            <td width="25%"><sd:Label>Số bản công</sd:Label></td>
                <td width="25%">
        ...
        <tr>
            <td width="25%" colspan="2" ><sd:Label>Hương, Vị, Độ nặng, Độ cháy, Màu sắc sợi</sd:Label></td>
    ...
    <table class="viewTable" id="detailDiv">
        <tr>
            <td><sd:Label>Thông tin bổ sung</sd:Label></td>
            </tr>
            <tr>
                <td>
...
<script type="text/javascript">
    dojo.connect(dijit.byId('files_tab_tablist_tab.productDetail'), "onClick", loadFormFromAnnounTab = function () {
        ...
        //        document.getElementById("createForm.detailProduct.businessName").innerHTML = dijit.byId("createForm.announcement.businessName").getValue();
        //        document.getElementById("createForm.detailProduct.productName").innerHTML = dijit.byId("createForm.announcement.productName").getValue();
        //        document.getElementById("createForm.detailProduct.announcementNo").innerHTML = dijit.byId("createForm.announcement.announcementNo").getValue();
    });
    ...
    page.afterLoadMainlyTarget = function (data) {
        ...
        if (result != null && result.length > 0) {
            for (var i = 0; i < result.length; i++) {
                var item = result[i];
                createNewMainlyTargetRow(item.isTemp, item.mainlyTargetId, item.targetName, item.unitId, item.publishLevel, item.meetLevel);
            }
        } else {
...
//     page.replaceNewLineByBrNew = function() {
...
//    page.loadIsHaveSubLabel = function() {
//        var isHaveSubLabel = dijit.byId("createForm.isHaveSubLabel").getValue();
//        if (isHaveSubLabel == '1') {
//            document.getElementById("lblIsHaveSubLabel").innerHTML = "Nội dung 'Nhãn phụ' đã được hệ thống tự động đính kèm cùng hồ sơ.";
//        } else {
//            document.getElementById("lblIsHaveSubLabel").innerHTML = "Nội dung 'Nhãn phụ' đã không được hệ thống tự động đính kèm cùng hồ sơ.";
//        }
//        document.getElementById("lblIsHaveSubLabel").style.color = "#ff0000";
//    };
//    page.loadIsHaveSubLabel();
</script>
