...
<form id="staffImportForm" name="staffImportForm">
    ...
    <table id="staffImportTable" style="border-width:thin; border-style:solid; border-color:#B5BACE; border-collapse:collapse;width:100%">
        <tr>
            <td align="center" width="50%" style="border-width:thin;  border-style:solid; border-color:#B5BACE;">
                <div align="center">
                    Click vào đây để tải về file mẫu: <a href="${contextPath}/share/BM_KhaiBao_2007.xlsx" target="self" id="linkFile">Excel 2007</a> | <a href="${contextPath}/share/BM_KhaiBao_2010.xlsx" target="self" id="linkFile">Excel 2010</a>
                </div>
                <br/>
    ...
    <div id="buttonImport2" style="text-align:center;">
...
<script>
    ...
    page.afterLoadExcel = function(data)
    {
        ...
        //var statusExcelNew = dijit.byId("createForm.statusExcel").getValue();
    ...
    page.checkExcel3 = function() {
        var check = '${checkEdit}';
        if (check == 1)
        {
            document.getElementById("buttonImport2").style.display = "none";
        }
        else
        {
            document.getElementById("buttonImport2").style.display = "";
        }
    };
    page.checkExcel3();
