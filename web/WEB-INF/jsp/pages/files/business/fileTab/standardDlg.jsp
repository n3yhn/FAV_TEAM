...
<script type="text/javascript">
    ...
    page.showAssignDlg = function(fileId) {
    ...
    page.InsertStaff = function() {
        ...
        if (items.length == 0) {
            msg.alert("Bạn chưa chọn đối tượng để gán", "Cảnh báo");
        }
    };
            ...
            page.updateDealine = function() {
                ...
                msg.confirm('<sd:Property>confirm.update</sd:Property>', "<sd:Property>confirm.title</sd:Property>", function() {
                    ...
                    page.saveProcess = function() {
                        ...
                        var countMainProcess = 0;
                        if (length == 0) {
                            alert("Chưa chọn người thẩm định");
                            return false;
                        }
//                        if (mainProcess) {
                            if (countMainProcess == 0) {
...
//                        }
                        msg.confirm('<sd:Property>confirm.update</sd:Property>', "<sd:Property>confirm.title</sd:Property>", function() {
                                    sd.connector.post("filesAction!onSaveProcess.do?" + token.getTokenParamString(), null, null, content, page.afterUpdateAssign);
                                });
                            };
