        ...
        <tr>
            <td width="25%"><sd:Label required="true">Số bản công bố</sd:Label></td>
                ...
                <sd:TextBox key="" id="createForm.announcement.announcementNo"
                            ...
                            value="${fn:escapeXml(createForm.announcement.announcementNo)}"/>
        ...
        <tr>
            ...
            <td width="25%"><sd:Label>Người ký</sd:Label></td>
                ...
                <sd:TextBox key="" id="createForm.announcement.signer"
                            ...
                            maxlength="255" cssStyle="width:99%"
                            trim="true" htmlAttributes="title='Tên người ký giấy'"/>
            </td>
        </tr>
    </table>
</sd:FieldSet>
    ...
    <table class="editTable">
        <tr>
            <td width="10%" ><sd:Label required="true">Về việc</sd:Label></td>
                <td width="90%" >
                <sd:TextBox key="" id="createForm.titleEdit"
                            name="createForm.titleEdit" 
                            cssStyle="width:99%;margin:auto;" trim="true"/>
            </td>
        </tr>
        <tr>
            <td width="10%" ><sd:Label required="true">Nội dung sửa đổi</sd:Label></td>
                <td width="90%" >
                <sd:Textarea key="" id="createForm.contentsEdit" 
                             name="createForm.contentsEdit" 
                             cssStyle="width:99%;margin:auto;" trim="true" rows="20"/>
            </td>
        </tr>
        <tr>
            <td width="10%"><sd:Label required="true">Ghi chú</sd:Label></td>
                <td width="90%">
                <sd:Textarea key="" id="createForm.noteEdit" 
                             name="createForm.noteEdit"  
                             cssStyle="width:99%;margin:auto;" trim="true" rows="10"/>
            </td>
        </tr>
    </table>
</sd:FieldSet>
