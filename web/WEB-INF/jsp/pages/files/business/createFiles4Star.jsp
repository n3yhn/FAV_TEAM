        ...
        <sd:Tab id="files_tab" height="750px" width="100%">
            <sd:ContentPane key="Bản công bố" id="tab.Announcement4Star">
                <div id="tabAnnouncement4StarDiv" style="overflow: auto;">
                    <jsp:include page="./fileTab/tabAnnouncement4Star.jsp"/>
                </div>
            </sd:ContentPane>
            <sd:ContentPane key="Thông tin chi tiết sản phẩm" id="tab.productInFile">
                <div id="tabProductInFileDiv" style="overflow: auto;">
                    <jsp:include page="./fileTab/tabProductInFile.jsp"/>
                </div>
            </sd:ContentPane>    
