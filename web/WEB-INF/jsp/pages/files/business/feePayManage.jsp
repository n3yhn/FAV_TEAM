...
<script>
    ...
    page.formatPay = function(inData)
    {
        ...
        var item = dijit.byId("FeeGrid").getItem(inData - 1);
        var url = "";
        //var url = "<div style='text-align:center;cursor:pointer;'><img src='share/images/icons/bill.png' width='17px' height='17px' title='Xác nhận nộp tiền mặt' onClick='page.checkPaymentCash(" + row + ");' /></div>";
        if (item != null) {
            ...
            switch (status) {
                ...
                case 5:
                    ...
                    break;
                default:
                    url += " <img src='share/images/icons/pay.jpg' width='17px' height='17px' title='Xác nhận nộp tiền mặt trực tiếp' onClick='page.checkPaymentCash(" + row + ");' />";
    ...
    <sd:TitlePane key="search.searchCondition" id="FeeTitle">
        <form id="searchFeeFormNew" name="searchFeeFormNew">
            ...
            <table width="100%;" cellpadding="0px" cellspacing="5px">
                ...
                <tr>
                    ...
                    <td>
                        <sd:SelectBox id="searchFeeFormNew.feePaymentType" name="searchFeeFormNew.feePaymentType" key=""  cssStyle="width:100%" >
                            <sd:Option selected="true" value='-1'>-- Chọn --</sd:Option>
                ...
                <tr>
                    ...
                    <td>
                        <sd:SelectBox id="searchFeeFormNew.status" name="searchFeeFormNew.status" key=""  cssStyle="width:100%" >
                            ...
                            <sd:Option value='0' selected="true">Chưa xác nhận</sd:Option>
                            <sd:Option value='2'>
                                Đã từ chối</sd:Option>
                        </sd:SelectBox>
                    </td>
                </tr>
                ...
                <!-- them nhom san pham - hieptq 17.11.14 -->
                <tr>
                    <td align="right">
                        <sd:Label key="Nhóm sản phẩm"/>
                    </td>
                    <td>
                        <sd:SelectBox id="searchFeeFormNew.productType" name="searchFeeFormNew.productType" key=""  cssStyle="width:100%" >
                            <sd:Option value='-1' selected="true">-- Chọn --</sd:Option>
                            <sd:Option value='2'>Nhóm sản phẩm thường</sd:Option>
                            <sd:Option value='1'>Các nhóm sản phẩm khác</sd:Option>
                        </sd:SelectBox>
                    </td>
...
<sd:Dialog  id="feePayManageDlg" height="auto" width="600px"
            key="Xác nhận thanh toán" showFullscreenButton="false"
            >
    <div id="feePayManageDiv">
        <jsp:include page="feePayManageDlg.jsp" flush="false"/>
    </div>
</sd:Dialog> 
<sd:Dialog  id="feePayManageViewDlg" height="auto" width="600px"
            key="Chi tiết thanh toán" showFullscreenButton="false"
            >
    <div id="feePayManageViewDiv">
        <jsp:include page="feePayManageViewDlg.jsp" flush="false"/>
    </div>
</sd:Dialog> 
...
<script>
    ...
    var dlgfeePayManage = dijit.byId("feePayManageDlg");
    var dlgfeePayViewManage = dijit.byId("feePayManageViewDlg");
    page.search = function() {
        ...
        grid.vtReload('filesAction!onSearchFeePayManage.do?userId=' + currentUserId, "searchFeeFormNew", null, null);
    };
    ...
    page.CheckPaymentEdit = function(inData)
    {
        var row = inData;
        var item = dijit.byId("FeeGrid").getItem(row);
        var payType = "";
        ...
        document.getElementById("tdBill1View").style.display = "";
        document.getElementById("tdBill2View").style.display = "";
        dijit.byId("Save2").domNode.style.display = "none";
