...
<form id="createFeeForm" name="createFeeForm">
    <table width="100%;" cellpadding="0px" cellspacing="5px">
        ...
        <tr style="text-align: center">
            <td colspan="4">
                <sd:Button id="Save2" key="" onclick="page.CheckCash();" cssStyle="display:none" >
                    <img src="${contextPath}/share/images/icons/Answer.png" height="14" width="18">
                    <span style="font-size:12px">Xác nhận</span>
                </sd:Button>
                <sd:Button id="Save3" key="" onclick="page.CheckOnline();" cssStyle="display:none" >
                    <img src="${contextPath}/share/images/icons/Answer.png" height="14" width="18">
                    <span style="font-size:12px">Xác nhận</span>
                </sd:Button>
...
<script>
    page.close = function() {
        ...
        dlgfeePayViewManage.hide();
    };

    page.CheckOnline = function() {

        var paymentInfoId = dijit.byId("createFeeForm.paymentId").getValue();
        sd.connector.post("feeAction!onSavePaymentOnline.do?paymentInfoId=" + paymentInfoId + "&" + token.getTokenParamString(), null, null, null, page.afterSavePaymentNew2);
    };
    page.CheckCash = function()
    {
        var paymentInfoId = dijit.byId("createFeeForm.paymentId").getValue();

        sd.connector.post("feeAction!onSavePaymentFinal.do?paymentInfoId=" + paymentInfoId + "&" + token.getTokenParamString(), null, null, null, page.afterSavePaymentNew1);
    };
