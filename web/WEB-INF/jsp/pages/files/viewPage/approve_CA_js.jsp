...
<script>
    page.preApproveCA = function() {
        ...
        var xmlContent = dijit.byId("createForm.contentXml").getValue();
        alert(xmlContent);
                        ...
                        if (firstIdx >= 0 && lastIdx >= 0)
                        {
                            ...
                            if (documentId == publishDocumentId)
                            {
                                ...
                                if (content != null) {
                                    ...
                                    sd.connector.post("filesAction!validateCA.do?" + token.getTokenParamString(), null, "createForm", null, function(data) {
