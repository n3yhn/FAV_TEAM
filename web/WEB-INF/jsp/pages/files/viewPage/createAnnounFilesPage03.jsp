...
<div class="buttonDiv" id="buttonDiv">
    ...
    <sd:Button id="btnAssignEvaluation" key="" onclick="page.showAssignDlg();" cssStyle="display:none" cssClass="buttonGroup">
        <img src="share/images/group.png" height="14" width="14" alt="Phân công hồ sơ"/>
        <span style="font-size:12px">Phân công hồ sơ</span>
    </sd:Button>
...
<form id="createForm" name="createForm">
    ...
    <sd:Tab id="files_tab" height="750px" width="100%">
        <sd:ContentPane key="Bản công bố" id="tab.annoucement">
            <div id="tabAnnouncement" style="overflow: auto;">
        ...
        <sd:ContentPane key="Thông tin chi tiết sản phẩm" id="tab.productDetail">
            <div id="tabProductDetailDiv" style="overflow: auto;">
                <jsp:include page="../fileViewTab/tabProductDetailTH.jsp"/>
            </div>
        </sd:ContentPane>    
        ...
        <sd:ContentPane key="Danh sách thay đổi sau công bố" id="tab.changes">
            <div id="tabChangesDiv" style="overflow: auto;">
                <jsp:include page="../business/fileTab/tabListFilesChanges.jsp"/>
            </div>
        </sd:ContentPane>
        <sd:ContentPane key="Công văn SĐBS sau công bố" id="tab.attachs2">
            <div id="tabAttachDiv2" style="overflow: auto;">
                <jsp:include page="../fileViewTab/tabAttachsSDBSSauCongBo.jsp"/>
            </div>
        </sd:ContentPane>
    </sd:Tab>
</form>
