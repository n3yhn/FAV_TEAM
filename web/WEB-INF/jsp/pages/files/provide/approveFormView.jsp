...
<table width="100%" class="viewTable">
    ...
    <tr>
        <td style="text-align: right"><sd:Label key="Nội dung quản lý phê duyệt, hoặc nội dung yêu cầu bổ sung"/></td>
        <td>
            <div id="approveFormView.staffRequest"></div>
        </td>
    </tr>
    <tr>
...
<script type="text/javascript">
    ...
    onCloseEvaluateView = function(){
        dijit.byId("approveViewDlg").hide();
    };
