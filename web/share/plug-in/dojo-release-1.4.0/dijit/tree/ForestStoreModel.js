...
if(!dojo._hasResource["dijit.tree.ForestStoreModel"]){
    ...
    dojo.declare("dijit.tree.ForestStoreModel",dijit.tree.TreeStoreModel,{
        ...
        getChildren:function(_3,_4,_5){
            if(_3===this.root){
                if(this.root.children){
                    ...
                    this.store.fetch({
                        query:this.query,
                        onComplete:dojo.hitch(this,function(_6){
        ...
        getChkChildren:function(_3,_4,_5){
            if(_3===this.root){
                if(this.root.children){
                    _4(this.root.children);
                }else{
        ...
        _requeryTop:function(){
            ...
            this.store.fetch({
                query:this.query,
                onComplete:dojo.hitch(this,function(_18){
