...
if(!dojo._hasResource["dijit.form.TextBox"]){
    ...
    dojo.declare("dijit.form.TextBox",dijit.form._FormValueWidget,{
        ...
        propercase:false,
        maxLength:"",
        templateString:"<div class=\"dijit dijitReset dijitLeft dijitTextBox\">\n\r<input class=\"dijit dijitReset dijitLeft\" dojoAttachPoint='textbox,focusNode'\n\tdojoAttachEvent='onmouseenter:_onMouse,onmouseleave:_onMouse'\n\t type=\"${type}\" ${nameAttrSetting}\n\t/>\n</div>\n\r",
        baseClass:"dijitTextBox",
        attributeMap:dojo.delegate(dijit.form._FormValueWidget.prototype.attributeMap,{
            maxLength:"focusNode"
        }),
        _getValueAttr:function(){ // LongH
