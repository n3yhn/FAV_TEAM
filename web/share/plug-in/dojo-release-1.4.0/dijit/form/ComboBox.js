...
//                }
        ...
        _showResultList:function(){
            ...
            this._arrowPressed();
            this.displayMessage("");
            dojo.style(this._popupWidget.domNode,{
                width:"",
                height:""
            });
            var _13=this.open();
            ...
            dojo.marginBox(this._popupWidget.domNode,{
                h:_13.h,
                w:Math.max(_15,this.domNode.offsetWidth)
                });
        ...
        doHighlight:function(_2f,_30){
            ...
            var ret=_32.replace(new RegExp("("+_30+")",_31),"<span class=\"dijitComboBoxHighlightMatch\">$1</span>");
            return ret;
        },
...
dojo.declare("dijit.form.ComboBox",[dijit.form.ValidationTextBox,dijit.form.ComboBoxMixin],{
    _setValueAttr:function(_47,_48,_49){
        this.item=null;
        if(!_47){
            _47="";
        }
