...
if(!dojo._hasResource["dijit.layout.AccordionContainer"]){
    ...
    dojo.declare("dijit.layout.AccordionContainer",dijit.layout.StackContainer,{
        ...
        _setupChild:function(_7){
            ...
            var _9=(_7._buttonWidget=new _8({
                contentWidget:_7,
                label:_7.title,
                title:_7.tooltip,
                iconClass:_7.iconClass,
                id:_7.id+"_button",
                parent:this
            }));
        ...
        _transition:function(_f,_10){
            ...
            if(_f){
                ...
                _11.push(dojo.animateProperty({
                    node:_13,
                    duration:this.duration,
                    properties:{
                        height:{
                            start:1,
                            end:this._getTargetHeight(_13)
                        }
                    },
            ...
            if(_10){
                ...
                _11.push(dojo.animateProperty({
                    ...
                    properties:{
                        height:{
                            start:this._getTargetHeight(_15),
                            end:1
                        }
                    },
                    onEnd:function(){
    ...
    dojo.declare("dijit.layout._AccordionButton",[dijit._Widget,dijit._Templated],{
