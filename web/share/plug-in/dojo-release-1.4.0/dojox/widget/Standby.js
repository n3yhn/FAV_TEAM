    ...
    dojo.declare("dojox.widget.Standby",[dijit._Widget,dijit._Templated],{
        ...
        _fadeIn:function(){
            ...
            var _20=dojo.animateProperty({
                duration:_1f.duration,
                node:_1f._underlayNode,
                properties:{
                    opacity:{
                        start:0,
                        end:0.75
...
_fadeOut:function(){
    ...
    var _24=dojo.animateProperty({
        duration:_23.duration,
        node:_23._underlayNode,
        properties:{
            opacity:{
                start:0.75,
                end:0
