...
if(!dojo._hasResource["dojox.layout.ExpandoPane"]){
    ...
    dojo.declare("dojox.layout.ExpandoPane",[dijit.layout.ContentPane,dijit._Templated,dijit._Contained],{
        maxHeight:"",
        maxWidth:"",
        splitter:false,
...
//            [duongtb
            this.originsize = dojo.contentBox(this.domNode).w;
//            ]
...
//            [duongtb:for resizing all grid in
               dojo.query(".dojoxGrid").forEach(function(grid_node, index){
...
//            ]
        ...
        _setupAnims:function(){
            ...
            var _5={
                ...
                },_6=this._isHorizontal,_7={},_8={},_9=_6?"height":"width";
            _7[_9]={
                end:this._showSize
                };
            _8[_9]={
            ...
            this._showAnim=dojo.animateProperty(dojo.mixin(_5,{
                easing:this.easeIn,
                properties:_7
            }));
            this._hideAnim=dojo.animateProperty(dojo.mixin(_5,{
                easing:this.easeOut,
                properties:_8
            }));
        ...
        resize:function(_a){
            ...
            this._contentBox={
                w:_b.w||dojo.marginBox(this.domNode).w,
                h:_b.h-this._titleHeight
                };
