...
if(!dojo._hasResource["dojox.grid._View"]){
    ...
    (function(){
        ...
        dojo.declare("dojox.grid._View",[dijit._Widget,dijit._Templated],{
            ...
            postCreate:function(){
                this.connect(this.scrollboxNode,"onscroll","doscroll"); //Linhntn for server paging
                //[duongtb

                dojox.grid.util.funnelEvents(this.contentNode,this,"doContentEvent",["mouseover","mouseout","click","dblclick","contextmenu","mousedown","change","keypress"]);
                dojox.grid.util.funnelEvents(this.headerNode,this,"doHeaderEvent",["dblclick","mouseover","mouseout","mousemove","mousedown","click","contextmenu","change","keypress"]);
                //]
