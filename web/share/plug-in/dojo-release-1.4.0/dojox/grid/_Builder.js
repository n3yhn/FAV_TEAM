    ...
    (function(){
        ...
        dg._ContentBuilder=dojo.extend(function(_25){
            ...
            generateHtml:function(_29,_2a){
                var _2b=this.getTableArray();
                var v=this.view,_2c=v.structure.cells;
                var _2d=this.grid.getItem(_2a);
        ...
        dg._HeaderBuilder=dojo.extend(function(_2f){
            ...
            generateHtml:function(_30,_31){
                ...
                for(var j=0,row;(row=_33[j]);j++){
                    ...
                    for(var i=0,_34,_35;(_34=row[i]);i++){
                        ...
                        if(_34.headerCheckbox !== undefined && _34.headerCheckbox == true && _34.type == dojox.grid.cells.vtBool){
                            _35[5]="<input style=\""+ (_34.headerStyles!=undefined?_34.headerStyles:"") + "\" type=\"checkbox\" id=\"cbx_" + this.grid.id +"\""+ (this.grid._checkAll == true?"  checked=\"checked\"":"") + " onclick='headerCheck(this);'/>";
                        }
                        //]
            ...
            colResizeSetup:function(e,_37){
                ...
                for(var i=0,_3c;(_3c=_3b[i]);i++){
                    _3a.push({
                        node:_3c,
                        index:this.getCellNodeIndex(_3c),
                        width:_3c.offsetWidth
                    });
                }
                ...
                for(var j=_3d.idx+adj,_40;(_40=_3e[j]);j=j+adj){
                    _3f.push({
                        node:_40.headerNode,
                        left:window.parseInt(_40.headerNode.style.left)
                    });
                }
