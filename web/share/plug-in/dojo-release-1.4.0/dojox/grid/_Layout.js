...
if(!dojo._hasResource["dojox.grid._Layout"]){
    ...
    dojo.declare("dojox.grid._Layout",null,{
        ...
        structure:null,
        defaultWidth:"6em",
        moveColumn:function(_2,_3,_4,_5,_6){
...
//            [duongtb
             if(_18 == dojox.grid.cells.Cell && _12.alwaysEditing==true){
                   _18  = dojox.grid.cells.Text;
                }
//            ]
        ...
        addViewDef:function(_23){
            ...
            return dojo.mixin({},_23,{
                cells:this.addRowsDef(_23.rows||_23.cells)
                });
        },
