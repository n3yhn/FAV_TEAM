    ...
    (function(){
        ...
        dojo.declare("dojox.grid.cells._Base",null,{
            ...
            format:function(_9,_a){
                ...
                var d=this.get?this.get(_9,_a):(this.value||this.defaultValue);
        ...
        dojo.declare("dojox.grid.cells.Cell",_5._Base,{
            ...
            keyFilter:null,
            formatEditing:function(_34,_35){
                ...
                if ((_34!== undefined)&&(_34 !== null))
                {
                    ...
                    if (typeof _34 === "string") {
                        var st1 =  _34.replace(/"/g,"&#34");
                        st2 =  st1.replace(/'/g,"&#39");
                    }
                    return "<input type=\"text\" style=\"border:1px solid;border-color:blue;height:" + this.getHeaderNode().offsetHeight +
                    "px;width:" + dojo.contentBox(this.getHeaderNode()).w + "px;\" value=\""+ st2 +"\" />";
                }
                else {
                    return "<input type=\"text\" style=\"border:1px solid;border-color:blue;height:" + this.getHeaderNode().offsetHeight +
                    "px;width:" + dojo.contentBox(this.getHeaderNode()).w + "px;\" value=\"\" />";
                }
        ...
        dojo.declare("dojox.grid.cells.Bool",_5.AlwaysEdit,{
            _valueProp:"checked",
            formatEditing:function(_4d,_4e){
        ...
        dojo.declare("dojox.grid.cells.Text", _5.AlwaysEdit, {
            formatEditing: function(inDatum, inRowIndex){
                return "<input type=\"text\" style=\"border:1px solid;border-color:blue;" + 
                "width:" + dojo.contentBox(this.getHeaderNode()).w + "px;\" value=\""+inDatum+"\" />";
            },
            doclick: function(e){
        ...
        _5.Text.markupFactory = function(node, cell){
            _5.AlwaysEdit.markupFactory(node, cell);
        };

        dojo.declare("dojox.grid.cells.vtBool",_5.AlwaysEdit,{
            _valueProp:"checked",
        ...
        _5.vtBool.markupFactory=function(node,cell){
            _5.AlwaysEdit.markupFactory(node,cell);
        };
        dojo.declare("dojox.grid.cells.Radio",_5.AlwaysEdit,{
            _valueProp:"checked",
            copyOf:function(item){
                var o1 = {};
                for(var key in item){
            ...
            formatEditing:function(_283,_284){
                ...
                if(typeof setChecked == 'function' || typeof setChecked == 'object') {
                    try{
                        checked = setChecked.call(this,_284);
                        if(this.grid._checked == null && this.grid.unchecked == false){
                            if(checked == true){
        ...
        _5.Radio.markupFactory=function(node,cell){
            _5.AlwaysEdit.markupFactory(node,cell);
        };
    //        ]
