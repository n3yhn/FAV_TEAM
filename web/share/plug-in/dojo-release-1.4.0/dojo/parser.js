...
if(!dojo._hasResource["dojo.parser"]){
    ...
    dojo.parser=new function(){
        ...
        function _7(_8){
            //[ Datbt
            // call require function befor parse
            try{
                if(_8!="dojox.grid._Expando" && _8!="dijit.layout._ScrollingTabControllerButton")
                    dojo.require(_8);
            }catch(e){
                console.debug("DatBT-parser.js-line91: " + e.message);
            }
            //] Datbt
            if(!_6[_8]){
