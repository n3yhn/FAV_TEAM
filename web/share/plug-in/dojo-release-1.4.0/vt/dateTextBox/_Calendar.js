dojo.provide("vt.dateTextBox._Calendar");
...
//                        switch(evt.keyCode){
//                            case dk.RIGHT_ARROW:
//                                this._adjustDisplayByKeyPress("day",1);
//                                dojo.stopEvent(evt);
//                                break;
//                            case dk.LEFT_ARROW:
//                                this._adjustDisplayByKeyPress("day",-1);
...
//                                break;
//                            case dk.UP_ARROW:
//                                this._adjustDisplayByKeyPress("day",-7);
//                                dojo.stopEvent(evt);
//                                break;
//                            case dk.DOWN_ARROW:
//                                this._adjustDisplayByKeyPress("day",7);
...
//                                break;
//                            case dk.PAGE_UP:
//                                this._adjustDisplayByKeyPress("month",-1);
//                                dojo.stopEvent(evt);
//                                break;
//                            case dk.PAGE_DOWN:
//                                this._adjustDisplayByKeyPress("month",1);
...
//                                var displayMonth = new Date(this.value);
//                                displayMonth.setHours(1);
//                                this.displayMonth = new Date(displayMonth);
//                                this._populateGrid();
//                                dojo.stopEvent(evt);
//                                break;
//                            case dk.END:
//                                this.value = dojo.date.add(this.value, "month", 1);
//                                this.value = dojo.date.add(this.value, "day", -1);
//                                this.attr('value', this.value);
//                                this.onValueSelected(this.attr('value'));
//                                var displayMonth = new Date(this.value);
//                                displayMonth.setHours(1);
...
//                        }
			...
			this.attr("value", newValue);
                ...
                _adjustDisplayByKeyPress: function(/*String*/ part, /*int*/ amount){
                    this.value = dojo.date.add(this.value, part, amount);
                    this.attr('value', this.value);
                    this.onValueSelected(this.attr('value'));
                    var displayMonth = new Date(this.value);
                    displayMonth.setHours(1);
