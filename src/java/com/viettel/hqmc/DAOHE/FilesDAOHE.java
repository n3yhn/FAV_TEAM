...
//        Files entity = (Files) findById(Files.class, "originalId", fileId);
        ...
        FilesForm form = null;
        try {
            if (entity != null && entity.getFileId() != null && entity.getFileId() > 0L) {
                form = new FilesForm(entity);
                if (entity.getAnnouncementId() != null) {
//                    Announcement objClone = (Announcement) findById(Announcement.class, "announcementId", entity.getAnnouncementId());
                    ...
                    Announcement objClone = objDaohe.findIsItempObj(entity.getAnnouncementId(), 0L, 0L, true);
...
/*
            ...
            if (bo.getStatus().equals(Constants.FILE_STATUS.NEW_CREATE) || bo.getStatus().equals(Constants.FILE_STATUS.RECEIVED_REJECT)) {
            ...
            if (processStatus.equals(Constants.FILE_STATUS.EVALUATED_TO_ADD) || processStatus.equals(Constants.FILE_STATUS.RECEIVED_REJECT_TO_ADD)) {
    ...
    public boolean onEvaluate(FilesForm form, Long deptId, String deptName, Long userId, String userName) {
        ...
        try {
            ...
            if ((file.getStatus() != null && form.getStatus() != null)//141225 binhnt update phan quyen ho so tham dinh
                ...
                if (form.getProductType() != null && form.getProductType() == 1L && form.getLeaderReviewId() != null) {//gui lanh dao tham dinh
                ...
                if (form.getStatus().equals(Constants.FILE_STATUS.EVALUATED) || form.getStatus().equals(Constants.FILE_STATUS.FEDBACK_TO_ADD)) {
                    ...
                    if (form.getProductType() != null && form.getProductType() == 1L && file.getLeaderEvaluateId() != null) {
...
//                        boolean bInsertRC = insertRequestComment(file.getFileId(), form, userId, userName, deptId, deptName, dateNow);//binhnt53 150130
                } else {
                    if (form.getStatus().equals(Constants.FILE_STATUS.EVALUATED_TO_ADD)) {
...
//!u150119 binhnt53 update lại nội dung thông tin.
                    ...
                    if ((form.getStatus()).equals(Constants.FILE_STATUS.FEDBACK_TO_EVALUATE)) {
                        ...
                        if (p != null) {
                            ...
                            ProcessDAOHE psdhe = new ProcessDAOHE();
                            Process pold = psdhe.getProcessByAction(form.getFileId(), Constants.Status.ACTIVE, Constants.OBJECT_TYPE.FILES, Constants.FILE_STATUS.EVALUATED, p.getStatus());
                            if (pold != null) {
                                newP.setReceiveGroup(pold.getSendGroup());
                                newP.setReceiveGroupId(pold.getSendGroupId());
                                ...
                                pold = psdhe.getProcessByAction(form.getFileId(), Constants.Status.ACTIVE, Constants.OBJECT_TYPE.FILES, Constants.FILE_STATUS.FEDBACK_TO_ADD, p.getStatus());
                                if (pold != null) {
                                    newP.setReceiveGroup(pold.getSendGroup());
                                    newP.setReceiveGroupId(pold.getSendGroupId());
                                    if (file != null && file.getStaffProcess() != null && file.getNameStaffProcess() != null) {
                ...
                if (form.getEvaluationRecordsForm() != null) {
                    ...
                    evaluationRecordsForm.setFilesStatus(file.getStatus());
                    evaluationRecordsForm.setMainContent(file.getStaffRequest());
                    ...
                    EvaluationRecordsFormOnGrid evaluationRecordsForm = new EvaluationRecordsFormOnGrid();
