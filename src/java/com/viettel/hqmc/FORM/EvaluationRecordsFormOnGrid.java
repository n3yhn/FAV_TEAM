 ...
 * @author binhnt53
 */
public class EvaluationRecordsFormOnGrid implements Serializable {
    ...
    public EvaluationRecordsFormOnGrid() {
    }

    public EvaluationRecordsFormOnGrid(EvaluationRecords entity) {
