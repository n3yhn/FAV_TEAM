...
public class ToHTML {
    ...
    public void printPage() throws IOException {
        try {
            ...
            if (completeHTML) {
                out.format(
                        "<?xml version=\"1.0\" encoding=\"utf-8s\" ?>%n");
                out.format("<html>%n");
                out.format("<head>%n");
                out.format("</head>%n");
                out.format("<body>%n");
    ...
    public void printStyles() {
        ...
        try {
            in = new BufferedReader(new InputStreamReader(org.apache.poi.ss.examples.html.ToHtml.class.getResourceAsStream("excelStyle.css")));
            String line;
