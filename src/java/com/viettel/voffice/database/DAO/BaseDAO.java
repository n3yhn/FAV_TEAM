...
public class BaseDAO extends BaseDAOMDBAction {
    ...
    public static final Long PROCESS_TYPE_MAIN_PROCESS = 1L;
    public static final Long PROCESS_TYPE_DOCUMENT = -1L;
    public static final Long PROCESS_TYPE_COOPERATE_PROCESS = 0L;
    public static final Long PROCESS_TYPE_COMMENT = 2L;
    public static final Long PROCESS_STATUS_NEW = 0L; // moi den
    public static final Long PROCESS_STATUS_BOOKED = 1L; // da luu so don vi
    public static final Long PROCESS_STATUS_INSTRUCTION = 2L; // da chuyen xin y kien chi dao
    public static final Long PROCESS_STATUS_ASSIGNED = 3L; // da phan cong cho chuyen vien
    public static final Long PROCESS_STATUS_FINISH = 4L; // hoan thanh
    public static final Long PROCESS_STATUS_RETURN = 5L; // tra lai
    public static final Long PROCESS_STATUS_APPROVED = 6L; // da phe duyet
    public static final Long PROCESS_STATUS_NEXT = 7L; // da chuyen tiep
    public static final Long PROCESS_JUST_REFERENCE = 11L; // Cong bo van ban
    public static final Long PROCESS_CV1FINISH = 12L; // Chuyen vien 1 da hoan thanh xu ly, CV2, PP xu ly tiep(review)
    public static final Long PROCESS_CV2FINISH = 13L; // Chuyen vien 2 da hoan thanh xu ly, PP xu ly tiep(review)
    public static final Long PROCESS_PPFINISH = 14L; // PP hoan thanh xu ly
    public static final Long DOING = 8L; // dang xu ly
    public static final Long DOCUMENT_STATUS_NEW = 0L; // moi den
    public static final Long DOCUMENT_STATUS_BOOKED = 1L; // da luu so don vi
    public static final Long DOCUMENT_STATUS_INSTRUCTION = 2L; // da chuyen xin y kien chi dao
    public static final Long DOCUMENT_STATUS_ASSIGNED = 3L; // da phan cong cho chuyen vien
    public static final Long DOCUMENT_STATUS_FINISH = 4L; // hoan thanh
    public static final Long DOCUMENT_STATUS_RETURN = 5L; // tra lai
    public static final Long DOCUMENT_STATUS_STORAGE = 9L;  // da luu tru
    public static final Long DOCUMENT_STATUS_CV1FINISH = 12L;  // Chuyen vien 1 da hoan thanh xu ly, CV2, PP xu ly tiep(review)
    public static final Long DOCUMENT_STATUS_CV2FINISH = 13L; // Chuyen vien 2 da hoan thanh xu ly, PP xu ly tiep(review)
    public static final Long DOCUMENT_STATUS_PPFINISH = 14L; // PP hoan thanh xu ly
    public static final Long PROCESS_STATUS_JUST_REFERENCE = 1l; // nhan de biet
    public static final Long OBJECT_TYPE_DOCUMENT_RECEIVE = 1l; // Van ban den
    public static final Long OBJECT_TYPE_DOCUMENT_PUBLISH = 2l; // Van ban di
    public static final Long OBJECT_TYPE_DOCUMENT_DIRECTION = 3l; // Van ban dieu hanh
    public static final Long OBJECT_TYPE_PROFILE_WORK = 4l; // ho so cong viec
    public static final Long OBJECT_TYPE_PROFILE_STORE = 5l; // Ho so luu tru
    public static final Long OBJECT_TYPE_FORM = 6l; // Phieu yeu cau
    public static final Long BOOK_TYPE_DOCUMENT_RECEIVE = 1l; // Phieu yeu cau
    public static final Long BOOK_TYPE_DOCUMENT_PUBLISH = 2l; // Phieu yeu cau
    public static final Long BOOK_TYPE_FORM = 3l; // Phieu yeu cau
    ...
    public static final Long BTP_ID = 52L; // ID Bo Tu Phap
